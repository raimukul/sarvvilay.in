      ...
      <div className="container">
        <div className="row d-flex mb-5 contact-info">
          ...
          <div className="col-md-3">
            <p><i className="fab fa-address" /> <span>Address:</span> 124, Nautan Road Marachhi, Siwan ( Bihar) India 841243</p>
          </div>
          <div className="col-md-3">
            <p><i className="fab fa-instagram" /> <span>Phone:</span> <a href="tel://+917320857665">+ 91 7320857665</a></p>
          </div>
          <div className="col-md-3"> 
            <p> <i className="fab fa-google-plus" /> <span>Email:</span> <a href="mailto: srvillay01@gmail.com"> srvillay01@gmail.com</a></p>
          </div>
          <div className="col-md-3">
            <p> <i className="fab fa-whatsapp" /> <span>Whatsapp</span> <a href="https://wa.me/917320857665">+ 91 7320857665</a></p>
          </div>
        </div>
